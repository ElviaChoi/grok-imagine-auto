(() => {
  ...
  if (!window.GrokAutoPlaceholderGuard) {
    throw new Error("GrokAutoPlaceholderGuard was not loaded before content.js.");
  }
  ...
  } = window.GrokAutoPlaceholderGuard;
  ...
  async function downloadMedia(url, filename) {
    ...
    if (await imageUrlLooksLikeBlackDotPlaceholder(url, { filename })) {
      throw new Error(
